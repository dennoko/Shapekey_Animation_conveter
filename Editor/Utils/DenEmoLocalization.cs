...
public static class DenEmoLoc
{
    ...
    ["ui.symmetry.tip"] = "末尾がL/Rのシェイプを1行にまとめ、左右を同時に編集します。",
        ...
        ["ui.timeline.menu.insertAllN"]  = "現在フレームにキーを一括追加 ({0} 個)",
        ["ui.timeline.menu.deleteFrame"] = "現在フレームの全キーを削除",
    ...
    ["ui.symmetry.tip"] = "Merge L/R-suffixed shapes into one row and edit both sides together.",
        ...
        ["ui.timeline.menu.insertAllN"]  = "Insert Keys at Current Frame ({0} visible)",
        ["ui.timeline.menu.deleteFrame"] = "Delete All Keys at Current Frame",
